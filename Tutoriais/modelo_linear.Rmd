...
Matematicamente, o resíduo para a observação $i$ é a diferença entre o valor real observado ($y_i$) e o valor predito pelo nosso modelo linear ($\hat{y}_i$):
...
segments(x0 = x, y0 = y, x1 = x, y1 = y_hat, col = "blue", lty = 2)
...
2. Extraímos os resíduos dessa regressão. Essa nova variável representará a variação de $x$ que é totalmente independente de $z$.
...
# 3. Regredimos Y contra esse X "purificado"
...
# Regredimos Y contra o Z "purificado"
